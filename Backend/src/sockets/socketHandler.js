...
//         delete lastCursorUpdate[leavingUser.userId];
//         // remove user
...
//         io.to(roomId).emit("user_left", leavingUser.userId);
//       }
//     });
...
//   if (lastCursorUpdate[userId] && now - lastCursorUpdate[userId] < 100) {
//     return;
//   }

//   lastCursorUpdate[userId] = now;

//   const member = rooms[roomId]?.find(
//     u => u.userId === userId
//   );

//   if (!member || member.role !== "editor") return;
